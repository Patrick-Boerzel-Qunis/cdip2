...
TARGET_TABLE = "bedirect_preprocessed"

# COMMAND ----------

bed_path = f"az://landing/{LANDING_IN_DIR}/bedirect_*.parquet"
storage_options = {"account_name": account_name, "account_key": account_key}
df = dd.read_parquet(bed_path, storage_options=storage_options, engine="pyarrow")
...
df= df.rename(columns = {'BE_ANZAHL_NIEDERLASSUNGEN_FILIALEN':'BE_ANZAHL_NL_FILIALEN'})
df.columns
