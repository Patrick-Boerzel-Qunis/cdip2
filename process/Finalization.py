...
from vst_data_analytics.public_flag import add_public_flag
...
df = add_public_flag(df, df_landkreis=df_landkreis, df_gemeinde=df_gemeinde, df_public_stichworte=df_public_stichworte)
